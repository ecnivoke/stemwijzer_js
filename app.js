let Stemwijzer = (function(){
	...
	let vote_btn_none 	= document.getElementById('vote_btn_none');
	let vote_btn_skip 	= document.getElementById('vote_btn_skip');

	let prev_btn 		= document.getElementById('prev_btn');
	let done_btn 		= document.getElementById('done_btn');
	let restart_btn 	= document.getElementById('restart')

	let show_opinion			= document.getElementById('show_opinion');
	let show_big_parties	 	= document.getElementById('show_big_parties');
	let show_secular_parties 	= document.getElementById('show_secular_parties');
